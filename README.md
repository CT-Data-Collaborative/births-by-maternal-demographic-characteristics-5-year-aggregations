...
[![Build Status](https://travis-ci.org/CT-Data-Collaborative/births-by-maternal-demographic-characteristics-5-year-aggregations.svg?branch=master)](https://travis-ci.org/CT-Data-Collaborative/births-by-maternal-demographic-characteristics-5-year-aggregations)

Births by Maternal Demographic Characteristics - 5-Year Aggregations reports the 3-year average number and percentage of births in certain categories by maternal demographic characteristics (mother's age, race, and ethnicity).
